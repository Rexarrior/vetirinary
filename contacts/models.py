...
class ContactInfo(models.Model):
    ...
    map_zoom = models.IntegerField(
        default=16, verbose_name="Масштаб карты", help_text="Значение от 1 до 19 (16-17 для улицы)"
    )
...
class ContactsPageText(models.Model):
    ...
    header_title = models.CharField(
        max_length=200, default="Как нас найти", verbose_name="Заголовок страницы"
    )
    ...
    form_title = models.CharField(
        max_length=200, default="Напишите нам", verbose_name="Заголовок формы"
    )
