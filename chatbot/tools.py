...
- Экстренная помощь: круглосуточно по телефону {contact.phone}
"""
...
• Для срочных вопросов о здоровье питомца — позвоните нам, мы работаем круглосуточно!
...
• Подскажу, когда стоит обратиться к ветеринару

Для срочных вопросов о здоровье животного — позвоните нам!"""
...
При серьёзных симптомах у животного — обязательно обратитесь к ветеринару!"""
